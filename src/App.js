...
function Tools({ key, name, picture, rating }) {
  return (
    <div>
      <div>
        my {key} Language is {name}
      </div>
      {rating}/5.0
      <div></div>
...
const programingLanguage = [
  {
    ...
    name: "C",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbfRfEPJG2DRSnFzWNygT8_KkUiUpYCd9U-w&usqp=CAUhttps://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbfRfEPJG2DRSnFzWNygT8_KkUiUpYCd9U-w&usqp=CAU",
    rating: 5.0,
  },
  {
    id: 2,
